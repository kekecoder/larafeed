               ...
               @endif
                <form action="{{ url('/login') }}" method="POST" class="pt-4">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="email" name="email" id="" class="bg-gray-50 border-2  text-green-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-800 dark:focus:ring-blue-500 dark:focus:border-blue-500 @if ($errors->has('email'))
                            is-invalid
                            @else
                            border-gray-300
